...
<head>
    ...
    <!-- Фавикон -->
    <link rel="shortcut icon" sizes="64X63>" href="{{ asset('img/favicon.png') }}" type="image/png">
...
<a href="{{ route('want') }}" class="btn__blue right-side">Хочу стать клиентом</a>

@if(Request::segment(1) === null || Request::segment(1) === 'search')
    <section class="categoy">
        <div class="container">
            @include('layout.partials.tags')
            <div class="row">
                <div class="col-lg-12">
                    <div class="categoty-wrapper mob two-row">
                        <div class="categoy-all"><img src="{{ asset('img/icon/category.svg') }}" alt="Все категории">
                            Все Категории
                        </div>
                    </div>
                </div>
...
<!-- Кнопка "Вверх" -->
<div class="top hvr-sink" title="Наверх"><i class="fa fa-angle-up" aria-hidden="true"></i></div>
...
@if(env('ENABLE_METRIC', true))
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/52163815" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
    ...
    <script id='chat-24-widget-code' type="text/javascript">
        !function (e) {
            ...
            window.chat24WidgetCanRun = 1, window.chat24WidgetCanRun && function () {
                window.chat24ID = "2fc8bc84f29f98e7dd4b369ebcc8b870", window.chat24io_lang = "ru";
                var e = "https://livechat.neirika.ru", t = document.createElement("script");
